...
class OverlayManager {
  ...
  void _showDialogInternal({
    ...
    final animation = animationController.drive(CurveTween(curve: Curves.easeOut));
  ...
  bool _removeDialog(String dialogId, [dynamic result]) {
    ...
    if (entry.handle.isAsync && entry.handle.completer != null && !entry.handle.completer!.isCompleted) {
      try {
